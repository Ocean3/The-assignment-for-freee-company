...
public class Seller extends User{
        ...
        public Seller(String fname, String lname, String mail, String phone, String uname,String pass, String am){
    ...
    /**
         * Following Button2Listner code was referenced from (Paul Deitel, 2012, p421)
     */
    ...
    public void Showingtransaction(File file, JViewport view){
        ...
        for(int i = 0 ; i < tra.size() ; i++){
            ...
            if(tra.get(i).equals(super.getUsername())){
                ...
                JLabel l1 = new JLabel("Transaction:"+ tra.get(i + 7 ));
                ...
                JLabel l2 = new JLabel("Seller:" + tra.get(i));
                l2.setFont(new Font("NSimSun", Font.PLAIN, 18));
                JLabel l3 = new JLabel("Buyer:"+ tra.get(i + 1));
                l3.setFont(new Font("NSimSun", Font.PLAIN, 18));
                JLabel l4 = new JLabel("Itemname:"+ tra.get(i + 3));
                l4.setFont(new Font("NSimSun", Font.PLAIN, 18));
                JLabel l5 = new JLabel("Number of item:"+ tra.get(i + 4));
                l5.setFont(new Font("NSimSun", Font.PLAIN, 18));
                JLabel l6 = new JLabel("Price:"+Integer.toString(Integer.parseInt(tra.get(i + 5)) * Integer.parseInt(tra.get(i + 4)))+"RM");
                l6.setFont(new Font("NSimSun", Font.PLAIN, 18));
                JLabel l7 = new JLabel("Success fee:"+Integer.toString(Integer.parseInt(tra.get(i + 5)) * Integer.parseInt(tra.get(i + 6)))+"RM");
    ...
    public void ShowingItem(File file, String item, JViewport view, String status){
        try{
            ...
            for(int i = 0; i < stri.size() ; i++){
                if(((stri.get(i).contains(item) && (stri.get(i+1).equals(super.getUsername())))) || ((item.equals("All")) && (stri.get(i).contains("@")) && (stri.get(i+1).equals(super.getUsername())))){
                    //Setting a panel
                    ...
                    prod.Itemsort = stri.get(i);
                    prod.Seller = stri.get(i + 1);
                    prod.Path = stri.get(i + 2);
                    prod.Itemname = stri.get(i + 3);
                    prod.Itemdescription = stri.get(i + 4);
                    prod.Itemnumber = stri.get(i + 5);
                    prod.Price = stri.get(i + 6);
                    ...
                    if(prod.Itemnumber.equals("0")){
                        ...
                        bt2.addActionListener(new Seller.Button2Listener(prod, status));
                        p5.add(l5);
                        p5.add(bt2);
                    }
                        ...
                        bt.addActionListener(new Seller.ButtonListener(prod, model, status));
                        JButton bt2 = new JButton("Delete");
                        bt2.addActionListener(new Seller.Button2Listener(prod, status));
                        p6.add(bt);
                        p6.add(bt2);
    ...
    //Checking whether th itemname and seller are corresponding with//
